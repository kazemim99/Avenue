    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (db.Roles.FirstOrDefault(x => x.Name != role.Name) == null)
                { 
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "بازیابی رمز عبور", "برای بازیابی اکانت خود لطفا  <a href=\"" + callbackUrl + "\">اینجا کلیک کنید</a>");
