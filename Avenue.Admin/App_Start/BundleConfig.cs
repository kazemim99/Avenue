...
namespace Avenue.Admin
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/custom-style").Include(
             "~/Content/app/css/custom-style.css"
            ));
            bundles.Add(new ScriptBundle("~/bundles/add-block").Include(
              "~/Content/js/add-block.js"
            ));
            bundles.Add(new ScriptBundle("~/bundles/ajax-jquary").Include(
              "~/Scripts/ajax-jquary.js"
              ));

            bundles.Add(new ScriptBundle("~/bundles/validate-jquary").Include(
               "~/Scripts/jquery.validate.min.js",
               "~/Scripts/jquery.validate.unobtrusive.min.js"
            ));
            bundles.Add(new StyleBundle("~/bundles/w3").Include(
             "~/Content/app/css/w3.css"
            ));
            //==============================Datatable RowReorder===============================//
            bundles.Add(new ScriptBundle("~/bundles/datatable-rowReorder-js").Include(
               //"~/Vendor/datatable-RowReorder-1.2.0/datatables.min.js",
               "~/Vendor/datatable-RowReorder-1.2.0/js/dataTables.rowReorder.min.js"

            ));
            bundles.Add(new StyleBundle("~/bundles/datatable-rowReorder-css").Include(
               //"~/Vendor/datatable-RowReorder-1.2.0/datatables.min.css",
               "~/Vendor/datatable-RowReorder-1.2.0/css/rowReorder.bootstrap.min.css"
            ));
        }
    }
}
