...
Date._expandFormat = function Date$_expandFormat(dtf, format) {
    ...
    if (len === 1) {
        ...
        case "D":
            return dtf.GuidDatePattern;
        case "t":
            return dtf.ShortTimePattern;
        case "T":
            return dtf.GuidTimePattern;
        case "f":
            return dtf.GuidDatePattern + " " + dtf.ShortTimePattern;
        case "F":
